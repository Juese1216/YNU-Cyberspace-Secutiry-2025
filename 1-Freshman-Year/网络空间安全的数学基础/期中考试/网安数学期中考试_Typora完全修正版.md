...
代入 \(pq = 437\)：  
$$
437 - p - q + 1 = 396 \Rightarrow 438 - (p + q) = 396 \Rightarrow p + q = 438 - 396 = 42
$$
...
设 \(p\) 和 \(q\) 是方程的根：  
$$
x^2 - (p+q)x + pq = 0 \Rightarrow x^2 - 42x + 437 = 0
$$

解这个方程：  
$$
x = \frac{42 \pm \sqrt{(-42)^2 - 4 \cdot 1 \cdot 437}}{2} = \frac{42 \pm \sqrt{1764 - 1748}}{2} = \frac{42 \pm \sqrt{16}}{2} = \frac{42 \pm 4}{2}
$$
